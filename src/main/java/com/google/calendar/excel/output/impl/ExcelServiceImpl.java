...
public class ExcelServiceImpl implements ExcelService {
	...
	@Override
	public void generateExcel(final String userName, final String projectNameAsString, final String clientNameAsString,
...
//					headerRow, columnSize);
			...
			setHeaderValue(sheet, clientNameAsString, userName,	projectNameAsString, dateList.get(0), dateList.get(1),
					headerRow, columnSize);
